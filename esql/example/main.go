...
func main() {
	...
	var sql = "SELECT a,b FROM `social.post*` WHERE `categories_id` IN ('171') AND `crate_time` BETWEEN 1699027200 AND 1724947200 ORDER BY `CALC(income.purchase.aggregate.balance)` DESC LIMIT 0,10"
